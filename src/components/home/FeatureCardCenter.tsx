...
interface FeatureCardCenterProps {
...
export const FeatureCardCenter: React.FC<FeatureCardCenterProps> = ({ 
  icon, 
  title, 
  description, 
  imageUrl,
  ...
  return (
    <div className={`${styles.card} w-full h-full max-w-xs mx-auto`} style={{ width: '240px', height: '320px' }}>
      <div className={styles.content}>
        {/* Back side - shown first */}
        <div className={styles.back}>
          <div className={styles["back-content"]}>
            <div className="h-16 w-16 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
              {React.cloneElement(icon as React.ReactElement, { className: 'h-8 w-8' })}
            </div>
            <p className="text-lg font-semibold text-white text-center px-4">{displayTitle}</p>
